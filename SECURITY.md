...
The Chrome extension reads transcript material from supported Teams recap pages and writes it under the browser's local Downloads directory. It contains no analytics, remote logging, or upload endpoint.
